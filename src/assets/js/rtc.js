...
window.addEventListener('load', () => {
    ...
    if (!room) {
        ...
        var socketId = '';
        var randomNumber = `${h.generateRandomString()}`;
        var myStream = '';
        var screen = '';
        var recordedStream = [];
        var mediaRecorder = '';
        ...
        function getAndSetUserStream() {
            ...
            if (h.userMediaAvailable) {
                ...
                h.getUserFullMedia().then((stream) => {
                    ...
                    var errmdis = document.getElementById("errmsg");
                    errmdis.innerText = `${e}`;

                    if (errmdis.innerText.startsWith("NotFoundError")) {

                        var errmdis = document.getElementById("errmsg");
                        errmdis.innerText = "Camera Permisson Is Not Found!";
                        ...
                        // Load the picture that you want to use as your stream.
                        image.src = 'https://thumbs.dreamstime.com/b/default-avatar-profile-image-vector-social-media-user-icon-potrait-182347582.jpg';
                        ...
                        const fkstream = canvas.captureStream();
